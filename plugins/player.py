...
async def not_chat(_, m: Message):
    if m.from_user is not None and m.from_user.id in Config.SUDO:
        ...
        buttons = [
            [
                InlineKeyboardButton('✨ 𝓢𝓤𝓟𝓟𝓞𝓡𝓣 ✨', url='https://t.me/Cineflixlk'),
                InlineKeyboardButton('⚡️ 𝓒𝓘𝓝𝓔 𝓕𝓛𝓘𝓧 ⚡️', url='https://t.me/CineFlixFinderBot'),
            ]
            ]
        await m.reply("<b>You can't use this bot in this group, for that you have to make your own bot from the [SOURCE CODE](https://github.com/ToxicBois44/VcplayerBot) below.</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
